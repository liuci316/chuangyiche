...
int Velocity,Velocity_KP,Velocity_KI;
int j,sum;
int Servo,Angle,SERVO_INIT,Tand,Target_Left,Target_Right,Encoder_Left,Encoder_Right,Motor_Left,Motor_Right;
int delay_flag,delay_50;
#define T 0.245f
#define L 0.29f
#define K 8.00f
/**************************************************************************
...
{
	    u8 temp;
			if(voltage<9500)//电池电压低于9.5V关闭电机
			{	                                                
      temp=1;      
     	PWMA1=0; //电机控制位清零                                           
			PWMB1=0; //电机控制位清零
